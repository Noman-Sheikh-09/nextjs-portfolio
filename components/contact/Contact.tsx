...
function Contact() {
  return (
    <div className="w-[100%] min-h-[100vh] bg-gray-100 mt-[5%] flex flex-col md:flex-row items-center px-[5%]">
      <div className="w-[100%] md:w-[50%] mt-[5%]  md:mt-[0px]  rounded-[20px] shadow-lg bg-white">
        <p className="font-bold text-[3rem] text-primary  pl-[8%] mt-[5%]">
          Let's work together
        </p>
        <div className="flex items-center flex-col md:flex-row justify-between px-[8%] mt-[5%]">
          <input
            type="text"
            placeholder="First Name"
            className="bg-gray-100 h-[50px] w-full  rounded-[10px] border border-primary outline-none pl-[10px]"
          />
          <input
            type="text"
            placeholder="Last Name"
            className="bg-gray-100 h-[50px] w-full mt-[20px] md:mt-0 rounded-[10px] border border-primary outline-none pl-[10px]"
          />
        </div>
        <div className="flex items-center flex-col md:flex-row justify-between px-[8%] mt-[20px] md:mt-[5%]">
          <input
            placeholder="Email"
            type="text"
            className="bg-gray-100 h-[50px] w-full rounded-[10px] border border-primary outline-none pl-[10px]"
      ...
      <div className="w-[100%] md:w-[50%] min-h-[90vh] ml-[5%]">
        <p className="font-bold text-[3rem] text-primary   mt-[5%]">
          Contact Details
        </p>
        ...
        <div className="flex items-center mt-[5%]">
          ...
          <div className="ml-[20px]">
            ...
            <p className="font-medium text-[20px] ">
              Near Iqbal Stadium,Faisalabad,Pakistan
            </p>
          </div>
        </div>
        <div className="flex items-center mt-[5%]">
